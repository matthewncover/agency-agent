...
# no time/sprint/daily-log/meta tools, and get_tracker_data stays personal
# (it carries daily-log reflections).
SHARED_TOOLS = {
    "get_task_detail",
    "get_open_tasks",
    "search_tasks",
...
def create_shared_app(engine: Engine | None = None, owner_id: int | None = None):
    ...
    by a repository that hides private personal tasks at the SQL layer.
