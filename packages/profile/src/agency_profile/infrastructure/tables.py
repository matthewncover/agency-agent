...
person = Table(
    ...
    Column("profile_id", BigInteger,
           ForeignKey("profile.profile.id", ondelete="CASCADE"), primary_key=True),
...
group_member = Table(
    "group_member", metadata,
    Column(
        "group_profile_id", BigInteger,
        ForeignKey("profile.group_profile.profile_id", ondelete="CASCADE"),
        primary_key=True,
    ),
    Column(
        "member_person_id", BigInteger,
        ForeignKey("profile.person.profile_id", ondelete="CASCADE"), primary_key=True,
    ),
)
